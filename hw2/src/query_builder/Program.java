...
/*
Задача 3: Реализовать простой фреймворк для создания SQL-запросов на основе Java
объектов.

Фреймворк должен позволять аннотировать классы и поля для связывания их с
таблицами и столбцами в базе данных.
...
2. Механизм генерации SQL-запросов:
    ...
    основе аннотаций.
    Используйте Reflection API для получения метаданных класса аннотированного
